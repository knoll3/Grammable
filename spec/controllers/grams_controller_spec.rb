...
RSpec.describe GramsController, type: :controller do
  ...
  describe 'grams#destroy action' do
    ...
    it "should not allow users who did not create the gram to destroy it" do
    ...
    it "should return a 404 message if we cannot find a gram with the id that is specified" do 
      user = FactoryBot.create(:user)
      sign_in user
      delete :destroy, params: { id: 'SPACEBALLS' }
  ...
  describe 'grams#update action' do
    ...
    it "should not let users who did not create the gram update it" do
      ...
      user = FactoryBot.create(:user)
      sign_in user
      patch :update, params: { id: gram.id, gram: { message: "I like beans" } }
      expect(response).to have_http_status(:forbidden)
    end
    ...
    it "should allow users to successfully create grams" do
